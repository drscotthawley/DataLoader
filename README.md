...
* **Editor**: @drscotthawley will serve as the "editor" (as with a book of submitted essays), and retain "editorial" authority regarding "lore", e.g. what constitutes "canon" and what doesn't.
...
* **Text**: Best if generated by ChatGPT or GPT-3 (e.g. the bio prompt was "write a brief bio for an AI DJ who is trying to convince people it is a real human DJ").
